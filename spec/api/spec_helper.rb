...
SCHEDULE_ACCOUNT_UPDATER_RESPONSE = <<EOS
<?xml version="1.0"?>
<soap:Envelope xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><soap:Body><recurring:scheduleAccountUpdaterResponse xmlns:recurring="http://recurring.services.adyen.com"><recurring:result><pspReference xmlns="http://recurring.services.adyen.com">2914394996653464</pspReference><result xmlns="http://recurring.services.adyen.com">Success</result></recurring:result></recurring:scheduleAccountUpdaterResponse></soap:Body></soap:Envelope>
EOS
